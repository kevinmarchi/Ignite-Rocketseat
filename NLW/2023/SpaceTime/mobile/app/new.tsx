    ...
    return (
        <ScrollView className="flex-1 px-8" contentContainerStyle={{paddingBottom: bottom, paddingTop: top}}>
            ...
            <View className="mt-6 space-y-6">
                ...
                >
                    {preview ? (
                        <Image source={{uri: preview}} className="h-full w-full rounded-lg object-cover"></Image>
                    ) : (
                        <View className="flex-row items-center gap-2">
                ...
                <TextInput 
                    ...
                    className="font-body text-lg text-gray-50 p-0"
                ...
                <TouchableOpacity activeOpacity={0.7} className='items-center rounded-full bg-green-500 px-5 py-2' onPress={handleCreateMemory}>
