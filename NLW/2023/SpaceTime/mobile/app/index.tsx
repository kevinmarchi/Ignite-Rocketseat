...
const discovery = {
  ...
  revocationEndpoint: 'https://github.com/settings/connections/applications/33d19f2ff8961871f713',
};
...
export default function App() {
  ...
  return (
    <ImageBackground source={blurBg} className='relative flex-1 bg-gray-900 px-8 py-10' imageStyle={{ position: 'absolute', left: '-100%' }}>
